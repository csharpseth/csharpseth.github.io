...
export const Projects: Project[] = [
    {
        ...
        previewText:"This application prompts you with a randomly selected social media post. Then, using a webcam, looks at your face, determines how you reacted, and interacts with the post accordingly.",
    ...
    },
    {
        ...
        previewText:"A website where you can plot positions. Then, calculate and sort the positions by distance to the origin. Choose from multiple sorting algorithms and drawing methods, and even read brief descriptions of the algorithm technique.",
    ...
    },
    {
        ...
        previewText:"A Kahoot clone, but better! Built with Express, React, and React Native. Functions similar to kahoot. Make an account, create a game, invite your friends, and quiz away on some randomly selected questions.",
