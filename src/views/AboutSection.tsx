            ...
            <div className="profile">
                <div className="info">
                    ...
                    <div className="social-links">
                        <a target="_blank" href="https://www.linkedin.com/in/sethhamm/"><img className="social-icon" src="/linkedin.png" alt="linkedin"/></a>
                        <a target="_blank" href="https://github.com/csharpseth"><img className="social-icon" src="/github.png" alt="github"/></a>
                        <a target="_blank" href="https://twitter.com/sethiesparkles"><img className="social-icon" src="/twitter.png" alt="twitter"/></a>
                        <a target="_blank" href="https://www.youtube.com/@codewithseth"><img className="social-icon" src="/youtube.png" alt="youtube"/></a>
                    </div>
                </div>
                <img className="profile-picture" src="/me.jpg" alt="My Profile Picture" />
            </div>
        </SectionComponent>
    )
}